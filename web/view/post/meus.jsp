...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/comentario.js"></script>
        <div class="well">
            <h1 class="text-center">Minha lista de posts</h1>

            <% int i = 0;%>
            <div>
                <c:forEach var="p" items="${postList}" varStatus="index">
                    <div class="row">
                        <div class="panel panel-default container-fluid col-md-11">
                        ...
                        <div class="col-md-1">
                            <div class="row">
                                <c:if test="${!p.republicacao}">
                                    <a href="${pageContext.servletContext.contextPath}/post/update?id=${p.id}" class="btn btn-sm btn-info glyphicon glyphicon-cog"></a>
                                </c:if>
                                <a href="${pageContext.servletContext.contextPath}/post/delete?id=${p.id}" class="btn btn-sm btn-danger glyphicon glyphicon-trash"></a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
